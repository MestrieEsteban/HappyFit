        ...
        <View style={profil.container}>
            ...
            <View style={profil.container2}>
               ...
               <Separator/>
                ...
                <View>
                <TouchableOpacity style={profil.button}
                    onPress={() => this.navigation()}>
                    <Text style={profil.text_button}>Editer</Text>
                </TouchableOpacity>

                <Text style={profil.text2} onPress={() => this.navigation()}> <AntDesign name="infocirlce" size={24} color="black" /> info</Text>
                <Text style={profil.text2} onPress={() => this.navigation()}> <AntDesign name="logout" size={24} color="black" /> Déconnecté</Text>
                </View>
