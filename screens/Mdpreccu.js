    ...
    return (
      <View style={mdpreccu.container}>
        ...
        <View style={mdpreccu.container2}>
          <FontAwesome style={mdpreccu.logo} name="check-square-o" size={180} color="black" />   
        </View>
        ...
        <View style={mdpreccu.container3}>
          ...
          <Text style={mdpreccu.text} onPress={() => this.props.navigation.navigate('Profil')}>Me renvoyer un mail</Text>      
        </View>
      </View>
    )
  }
